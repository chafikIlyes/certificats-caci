...
import { ImportateurComponent } from 'app/entities/importateur/importateur.component';
...
describe('Component Tests', () => {
  describe('Importateur Management Component', () => {
    let comp: ImportateurComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ImportateurComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.importateurs && comp.importateurs[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
