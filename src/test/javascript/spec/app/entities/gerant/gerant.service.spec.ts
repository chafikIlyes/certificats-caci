...
describe('Service Tests', () => {
  describe('Gerant Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(GerantService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new Gerant(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Gerant', () => {
        ...
        service.create(new Gerant()).subscribe(resp => (expectedResult = resp.body));
