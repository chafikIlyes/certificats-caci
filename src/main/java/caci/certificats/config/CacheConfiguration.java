package caci.certificats.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, caci.certificats.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, caci.certificats.repository.UserRepository.USERS_BY_EMAIL_CACHE);
